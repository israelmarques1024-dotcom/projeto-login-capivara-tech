...
btnCadastro.addEventListener('click', () => {
    ...
    fetch('https://israelmarques1024-dotcom.github.io/projeto-login-capivara-tech/cadastrar', {
        method: 'POST',
...
btnLogin.addEventListener('click', () => {
    ...
    fetch('https://israelmarques1024-dotcom.github.io/projeto-login-capivara-tech/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email, senha })
    })
